...
namespace TrexRunner
{
    ...
    public class TRexRunnerGame : Game
    {
        ...
        public const int TREX_START_POS_X = 40;
        ...
        private bool StartGame()
        {
            ...
            _scoreBoard.Score = 0;
            _fadeInTexturePosX = TREX_START_POS_X + Trex.TREX_DEFAULT_SPRITE_WIDTH;
        ...
        public void LoadSaveState()
        {
            try
            {
                if (File.Exists(SAVE_FILE_NAME))
                {
                    ...
                    SaveState saveState = JsonSerializer.Deserialize<SaveState>(json);
